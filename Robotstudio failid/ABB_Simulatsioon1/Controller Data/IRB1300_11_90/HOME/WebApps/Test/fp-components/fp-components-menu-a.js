                        ...
                        for (let item of content) {
                            ...
                            if (item.type === "button") {
                                ...
                                if (item.icon !== undefined) {
                                    ...
                                    imgNode.src = item.icon;
                                    imgNode.className = "fp-components-common-icon-40 fp-components-menu-a-button-icon";
                                ...
                                if (item.arrow !== undefined && (item.arrow === true || item.arrow === "true")) {
                                    ...
                                    arrowNode.src = "fp-components/img/rightarrow.png";
                                    arrowNode.className = "fp-components-menu-a-button-righticon fp-components-common-icon-32";
