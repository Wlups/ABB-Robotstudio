...
declare namespace TComponents {
  ...
  class Component_A extends Base_A {
    ...
    async syncInputData(): Promise<boolean>;
  }
  ...
  class Page extends Component_A {
    constructor(parent: TComponentParent, props?: PageProps);
    protected prop: PageProps;
    properties: object;
    getCssText();
  }
}
